...
('svc_social_media', 'Meta & Social Media Ad Campaigns', 'Socialmedia', 'Socialmedia', 'Reels, Story Ads & Performance Collabs', 'Meta & Social Ads Network', '10M+ Targeted Monthly Reach • 3.2% CTR', 25000, 55000, 4.9, 96, 'Active', '9:16 Reels • 1:1 Feed • Story Motion Creatives', '2 Weeks, 1 Month, 3 Months, 6 Months', 'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?q=80&w=800&auto=format&fit=crop', 'Hyper-targeted social media advertising across Instagram, Facebook, YouTube and LinkedIn. Complete high-converting video creative generation, demographic targeting, scaling, and daily analytics.'),
('svc_web_dev', 'Campaign Landing Pages & Web Development', 'Development', 'Development', 'High-Speed Web Apps & Ad Tech Portals', 'Laxico AdTech Suite', '99.9% Uptime • Sub-second Load • Lead Capture', 35000, 75000, 4.9, 92, 'Active', 'Mobile & Desktop Responsive • Fast Web Apps', 'One-Time Project, 1 Month Support, 3 Months Support', 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=800&auto=format&fit=crop', 'High-performance marketing landing pages, interactive campaign websites, QR code scan tracking, and lead CRM integrations engineered for maximum conversion.'),
('svc_drone_shows', 'Aerial Drone Light Shows & Sky Branding', 'Drone Marketing', 'Drone Marketing', 'Synchronized LED Drone Swarm Shows', 'Laxico SkyFleet Drones', '5L+ Live Viewers • Massive Viral Social Reach', 150000, 250000, 5.0, 99, 'Active', '100–500 Swarm Drones • 400ft Sky Canvas', '1 Night Event, 3 Days Festival, 1 Week Tour', 'https://images.unsplash.com/photo-1508614589041-895b88991e3e?q=80&w=800&auto=format&fit=crop', 'Spectacular synchronized drone light shows painting 3D company logos, animated figures, and scannable QR codes across the night sky. Unmatched viral impact for launches and major events.')
