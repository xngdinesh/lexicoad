...
export const initialServices = [
  {
    id: 'svc_cinema_pvr',
    name: 'PVR INOX Multiplex Cinema Ads',
    type: 'Cinema',
    genre: 'Cinema',
    sub_type: 'On-Screen Video & Slide Ads',
    chain_or_brand: 'PVR INOX',
    audience_metric: '280 Seats/Screen • 4.2L+ Monthly Footfall',
    min_spend: 11400,
    price: 32000,
    rating: 4.9,
    popularity: 97,
    status: 'Active',
    dims: '2K / 4K DCP • 10–30s Spots',
    durations: '1 Week, 2 Weeks, 1 Month, 3 Months',
    cities: 'Mumbai, Bengaluru, Delhi NCR, Hyderabad, Pune',
    image: 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?q=80&w=800&auto=format&fit=crop',
    description: 'Captive, high-impact cinema advertising across premium PVR and INOX audi screens. On-screen slides, Dolby Atmos cinema video commercials, and lobby standees during blockbuster releases.'
  },
  {
    id: 'svc_cinema_cinepolis',
    name: 'Cinepolis Fun Republic On-Screen Ads',
    type: 'Cinema',
    genre: 'Cinema',
    sub_type: 'Digital Screen & Slide Ad',
    chain_or_brand: 'Cinépolis',
    audience_metric: '252 Seats/Screen • High Affluent Youth Dwell',
    min_spend: 6080,
    price: 18500,
    rating: 4.8,
    popularity: 91,
    status: 'Active',
    dims: 'Full Cinema Screen • High Lumen DCP',
    durations: '1 Week, 2 Weeks, 1 Month',
    cities: 'Mumbai, Bengaluru, Pune, Delhi NCR',
    image: 'https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?q=80&w=800&auto=format&fit=crop',
    description: 'High-visibility digital slides and video commercials before movie trailers and interval. Reach young, tech-savvy cinema-goers across premier Cinepolis locations.'
  },
  {
    id: 'svc_metro',
    name: 'Metro Station Ads & Train Wraps',
    type: 'Transit',
    genre: 'Transit',
    sub_type: 'Concourse & Train Branding',
    chain_or_brand: 'Metro Rail Network',
    audience_metric: '2.5L+ Daily Commuters per Hub',
    min_spend: 15000,
    price: 45000,
    rating: 4.9,
    popularity: 98,
    ...
    cities: 'Delhi NCR, Bengaluru, Mumbai, Hyderabad',
    image: 'https://images.unsplash.com/photo-1474487548417-781cb71495f3?q=80&w=800&auto=format&fit=crop',
    description: 'Dominate concourses, platforms, entry gates and ticket counters across DMRC & metro networks. Backlit boxes, platform screen doors, staircase wraps and train-wrap options.'
  },
  {
    id: 'svc_bus',
    name: 'Bus Shelter Posters & Mupis',
    type: 'Transit',
    genre: 'Transit',
    sub_type: 'Bus Queue Shelter Mupi',
    chain_or_brand: 'City Transit Network',
    audience_metric: '45,000+ Daily Eye-Level Vehicular Views',
    min_spend: 9000,
    price: 18000,
    rating: 4.7,
    popularity: 86,
    ...
    cities: 'Bengaluru, Delhi NCR, Mumbai, Hyderabad',
    image: 'https://images.unsplash.com/photo-1570125909232-eb263c188f7e?q=80&w=800&auto=format&fit=crop',
    description: 'Street-level frequency across high-traffic bus queue shelters. Backlit mupis with eye-level dwell time of 4–8 minutes. Sold in targeted clusters for prime coverage.'
  },
  {
    id: 'svc_airport',
    name: 'Airport Banners & Aerobridge Wraps',
    type: 'Airport',
    genre: 'Airport',
    sub_type: 'Arrival & Aerobridge Branding',
    chain_or_brand: 'International Airport Hubs',
    audience_metric: '95,000+ Daily Affluent Flyers',
    min_spend: 45000,
    price: 95000,
    rating: 4.9,
    popularity: 94,
    ...
    description: 'Premium arrival, departure and baggage-belt banners at T3, T2 and leading airports. Reach affluent business flyers and CXOs with average dwell of 25+ minutes.'
  },
  {
    id: 'svc_highway',
    name: 'Highway Unipoles & City Hoardings',
    type: 'Outdoor',
    genre: 'Outdoor',
    sub_type: 'Large Format Unipole',
    chain_or_brand: 'National Highway & Expressway',
    audience_metric: '1.2M+ Vehicular Impressions Weekly',
    min_spend: 35000,
    price: 75000,
    rating: 4.8,
    popularity: 95,
    ...
    description: 'Iconic large-format unipoles on NH-48, Eastern Expressway, Airport Road and city arterial gateways. Front-lit illumination for 24/7 brand recall.'
  },
  {
    id: 'svc_led',
    name: 'Tech Park & Mall Digital DOOH Screens',
    type: 'Digital',
    genre: 'Digital',
    sub_type: 'Digital DOOH LED Wall',
    chain_or_brand: 'Corporate Parks & Malls',
    audience_metric: '1.8L+ Daily Tech Professionals & Shoppers',
    min_spend: 20000,
    price: 88000,
    rating: 4.9,
    popularity: 92,
    ...
    description: 'Programmatic-grade LED walls at Cyber City, BKC, Manyata Tech Park & Whitefield. Day-parting, live data feeds and instant creative swaps. 120 spots/day guaranteed.'
  },
  {
    id: 'svc_mall',
    name: 'Mall Atrium Drops & Facade Displays',
    type: 'Retail',
    genre: 'Retail',
    sub_type: 'Atrium Drop & Pillar Wrap',
    chain_or_brand: 'Grade-A Malls',
    audience_metric: '3.5L+ Weekend Shopper Footfall',
    min_spend: 18000,
    price: 55000,
    rating: 4.6,
    popularity: 83,
    status: 'Active',
    dims: 'Custom • Multi-Tier Atrium',
    durations: '1 Week, 2 Weeks, 1 Month, 3 Months',
    cities: 'Mumbai, Bengaluru, Delhi NCR, Pune',
    image: 'https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?q=80&w=800&auto=format&fit=crop',
    description: 'Atrium hangings, facade glow-signs, food-court table wraps and entrance totems in top tier-1 malls. Exceptional engagement for D2C product launches and festive sales.'
  },
  {
    id: 'svc_railway',
    name: 'Railway Station Hoardings & FOBs',
    type: 'Transit',
    genre: 'Transit',
    sub_type: 'Platform & Foot-Over-Bridge',
    chain_or_brand: 'Indian Railways Network',
    audience_metric: '4.5L+ Mass Daily Footfall',
    min_spend: 25000,
    price: 62000,
    rating: 4.7,
    popularity: 85,
    ...
    durations: '1 Month, 3 Months, 6 Months, 12 Months',
    cities: 'Mumbai, Delhi NCR, Bengaluru, Hyderabad',
    image: 'https://images.unsplash.com/photo-1565019011521-b0575cbb57c8?q=80&w=800&auto=format&fit=crop',
    description: 'Concourse hoardings, foot-over-bridge panels and platform boards at CST, New Delhi, Howrah & major junctions. Unmatched reach for mass FMCG and consumer banking.'
  },
  {
    id: 'svc_pole',
    name: 'Arterial Street Pole Kiosks',
    type: 'Street Furniture',
    genre: 'Street Furniture',
    sub_type: 'Double-Sided Backlit Pole',
    chain_or_brand: 'Municipal Arterial Roads',
    audience_metric: '80,000+ Vehicles Daily / Corridor',
    min_spend: 12000,
    price: 14000,
    rating: 4.5,
    popularity: 76,
    ...
    description: 'Double-sided backlit kiosks on arterial lamp posts. Hyperlocal repetitive domination along prime consumer stretches — ideal for real-estate, hospitals and retail openings.'
  },
  {
    id: 'svc_btl_activation',
    name: 'Gated Society & Corporate BTL Activations',
    type: 'BTL',
    genre: 'BTL',
    sub_type: 'Canopy Setup & Product Sampling',
    chain_or_brand: 'Premium Societies & Tech Parks',
    audience_metric: '2,500+ Qualified High-Net-Worth Households',
    min_spend: 15000,
    price: 38000,
    rating: 4.8,
    popularity: 88,
    status: 'Active',
    dims: '10 × 10 ft Promotional Canopy + Promoters',
    durations: '1 Weekend, 2 Weekends, 1 Month',
    cities: 'Bengaluru, Mumbai, Delhi NCR, Hyderabad',
    image: 'https://images.unsplash.com/photo-1511578314322-379afb476865?q=80&w=800&auto=format&fit=crop',
    description: 'Direct interactive kiosk activations, product sampling, and test-drive booths in premier residential townships and tech park cafeterias with verified lead capture.'
  },
  {
    id: 'svc_print_newspaper',
    name: 'Leading Newspaper Jackets & Display Ads',
    type: 'Print',
    genre: 'Print',
    sub_type: 'Front Page Jacket & Display Ad',
    chain_or_brand: 'National & Regional Dailies',
    audience_metric: '8.5L+ Verified Daily Circulation',
    min_spend: 30000,
    price: 85000,
    rating: 4.7,
    popularity: 82,
    status: 'Active',
    dims: 'Full Page / Half Page / Jacket',
    durations: '1 Insertion, 3 Insertions, 6 Insertions',
    cities: 'Delhi NCR, Mumbai, Bengaluru, Hyderabad',
